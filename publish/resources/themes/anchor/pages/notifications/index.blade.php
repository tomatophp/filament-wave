<?php
	...
	new class extends Component{
		...
		public function delete($id){
			$notification = auth('accounts')->user()->notifications()->where('id', $id)->first();
			if ($notification){
				$notification->delete();
			}
			$this->updateNotifications();
		...
		public function updateNotifications(){
			$this->setUnreadNotifications = $this->unreadNotifications = auth('accounts')->user()->unreadNotifications->all();
			$this->notifications_count = auth('accounts')->user()->unreadNotifications->count();}
		}
?>
