<x-filament-widgets::widget class="flex gap-x-5 fi-filament-info-widget">
        ...
        <div class="flex gap-x-5 items-center">
            ...
            <div class="w-full">
                <div class="flex flex-col">
                    <div class="mt-1 text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-200">{{ \Wave\Models\User::count() }}</div>
                </div>
            </div>
    ...
    <x-filament::section class="w-full">
        <div class="flex gap-x-5 items-center">
            ...
            <div class="w-full">
                <div class="flex flex-col">
                    <div class="mt-1 text-xl font-semibold tracking-tight text-gray-900 dark:text-gray-200">{{ \Wave\Models\User::count() }}</div>
                </div>
            </div>
