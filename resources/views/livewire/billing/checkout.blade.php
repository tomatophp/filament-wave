                            ...
                            <div class="p-6 lg:p-8">
                                <div class="relative text-gray-500 dark:text-neutral-400">
                                    <span lass="text-lg md:text-xl font-semibold rounded-full">
                                        {{ $plan->name }} {{ trans('circlexo.settings.subscription.plan') }}
                                ...
                                <ul class="flex flex-col mt-5">
                                    @foreach($features as $feature)
                                        <li class="mt-1 text-sm">
                                            <span class="flex gap-2 items-center text-green-500">
                                                <svg class="w-4 h-4  fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M0 11l2-2 5 5L18 3l2 2L7 18z"></path></svg>
